...
<div class="container_center">
    ...
    <div class="blogTop">
        <div class="blogTop__img">
            <?php if ($top_video) : ?>
                <video src="<?php echo wp_get_attachment_url($top_video) ?>" muted autoplay loop></video>
            <?php else : ?>
        ...
        <div class="blogTop__content">
            ...
            <div class="blogTop__link">
                <a href="<?php echo get_the_permalink($top_post); ?>" class="btn">Read more</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="blogRelated__item">
                        <?php if ($video) : ?>
                            <div class="blogRelated__img">
                                <video src="<?php echo wp_get_attachment_url($video) ?>" muted autoplay loop></video>
                            </div>
                        <?php else : ?>
